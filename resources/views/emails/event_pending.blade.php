...
<head>
    <meta charset="utf-8">
    <title>Event Registration Request Received</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="message">
                Thank you for submitting your RSVP! Your registration request has been successfully logged. Because this committee assembly requires formal review and seat approval by the secretariat, your seat status is currently marked as <strong>Pending</strong>.
            </p>

            <!-- Ticket details -->
            <div class="ticket">
                <h4 class="ticket-title">RSVP REQUEST DETAILS</h4>
            ...
            <p class="message" style="margin-bottom: 0;">
                No action is required from you at this time. The secretariat is verifying the registration details and seat allocations. As soon as your request is processed, you will receive another email confirmation containing your official digital pass, ticket code, and secure check-in instructions.
            </p>
        </div>
