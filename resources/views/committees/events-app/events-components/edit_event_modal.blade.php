...
<div id="edit-event-modal"
    ...
    <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 max-w-3xl w-full shadow-2xl flex flex-col max-h-[92vh] transition-all duration-300 transform scale-95 opacity-0 overflow-hidden"
        ...
        <form action="{{ route('committees.events.update', $event) }}" method="POST" enctype="multipart/form-data" class="flex-grow flex flex-col min-h-0">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <p class="text-[9px] text-slate-400 dark:text-slate-500 mt-1">Upload a new cover image directly to the cloud bucket to replace the current one.</p>
                        </div>
                ...
                <div class="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_rgba(15,23,42,0.02)] space-y-4">
                    ...
                    <div class="flex items-center justify-between p-3 rounded-2xl bg-slate-50/50 dark:bg-slate-950/20 border border-slate-100 dark:border-slate-800/80">
                        <div class="flex flex-col text-left">
                            <label for="edit_allow_group_registration" class="text-xs font-bold text-slate-700 dark:text-slate-350">Allow Group Registration</label>
                        ...
                        <label class="relative inline-flex items-center cursor-pointer select-none">
                            ...
                            <input type="checkbox" name="allow_group_registration" id="edit_allow_group_registration" value="1"
                                {{ $event->allow_group_registration ? 'checked' : '' }}
                                class="sr-only peer">
