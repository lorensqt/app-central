                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <select id="gender-select" onchange="handleGenderChange(this)" {{ ($fieldsConfig['gender']['required'] ?? false) ? 'required' : '' }} 
                                            class="w-full rounded-xl border border-slate-200 dark:border-slate-800 py-3 pl-4 pr-10 text-slate-650 dark:text-slate-300 text-sm focus:border-purple-500 focus:ring-4 focus:ring-purple-500/10 focus:outline-none bg-slate-50/50 dark:bg-slate-950/50 focus:bg-white dark:focus:bg-slate-950 transition-all duration-300 appearance-none">
